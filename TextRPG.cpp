...
void combatRound(Character &player, Enemy &enemy)
{
    ...
    case 1:
    {
        ...
        int damagePlayer1 = player.attack() - enemy.getEnemyDefence();
        ...
        int damageEnemy1 = enemy.attackCharacter() - player.getDefence();
    ...
    case 2:
    {
        ...
        int damageEnemy2 = enemy.attackCharacter() - (2 * player.getDefence());
        ...
        int damagePlayer2 = (player.attack()) - enemy.getEnemyDefence();
...
int main()
{
    ...
    {
        combatRound(myCharDefault, enemyGoblin);
    }

    cout << myCharDefault.getNickName() << " defeats the " << enemyGoblin.getEnemyName() << "!" << endl;
